...
public class EventBusActivityScope {
    public static final String TAG = EventBusActivityScope.class.getSimpleName();
    private static AtomicBoolean sInitialzed = new AtomicBoolean(false);
