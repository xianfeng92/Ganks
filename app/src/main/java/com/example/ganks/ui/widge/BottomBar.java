...
public class BottomBar extends LinearLayout {
    ...
    public BottomBar addItem(final BottomBarTab bottomBarTab){
        bottomBarTab.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mListener == null){
                    return;
                }
                int pos = bottomBarTab.getTabPostion();
        ...
        bottomBarTab.setTabPostion(mTabLayout.getChildCount());
    ...
    public void setCurrentItem(final int postion){
        mTabLayout.post(new Runnable() {
            @Override
            public void run() {
                mTabLayout.getChildAt(postion).performClick();
            }
        });
    }
