...
public class RetrofitUtils {
    ...
    public OkHttpClient getOkHttpClientBase(final Map<String, Object> headerMap, final HttpObserver httpObserver) {
        ...
        return getOkHttpClient(false, retroHttpConfig.getInstance().getTimeout(), retroHttpConfig.getInstance().getTimeUnit(), interceptorArray);
    }
}
